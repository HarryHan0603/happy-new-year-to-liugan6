...
setTimeout(() => {
    displayText = "願妳每天都能擁有快樂的心情😄"; // 40 秒後顯示
}, 85000);
...
setTimeout(() => {
    displayText = "遇見更多的美好與驚喜！🥰"; // 50 秒後顯示
}, 95000);
...
setTimeout(() => {
    displayText = "無論是學業📖還是生活🎉"; // 50 秒後顯示
}, 115000);
...
setTimeout(() => {
    displayText = "Happy New Year,劉宸羽!🎊🎊🥳"; // 50 秒後顯示
}, 135000);
